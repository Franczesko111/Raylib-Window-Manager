...
win:
	g++ $(SOURCE_FILES) -o $(PROGRAM_NAME) -include $(PRECOMPILED_HEADER_PATH)/PCH.hpp $(ARGUMENTS) -std=c++$(CPP_VERSION) -I $(INCLUDE_PATH) -L $(INCLUDE_PATH) -lraylib -lopengl32 -lgdi32 -lwinmm
win_fast:
	g++ -O2 $(SOURCE_FILES) -o $(PROGRAM_NAME) $(ARGUMENTS) -std=c++$(CPP_VERSION) -I $(INCLUDE_PATH) -L $(INCLUDE_PATH) -lraylib -lopengl32 -lgdi32 -lwinmm
